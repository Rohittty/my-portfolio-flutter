...
class TaxHelpDetailScreen extends StatelessWidget {
  ...
  static const _playStoreUrl =
      'https://play.google.com/store/apps/details?id=com.taxhelpdesk.me';
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [
                        AppTheme.flutterPrimary.withValues(alpha: 0.12),
                        Colors.transparent,
                      ],
                    ),
                    borderRadius: BorderRadius.circular(12),
                    border: Border.all(
                      color: AppTheme.flutterPrimary.withValues(alpha: 0.18),
                    ),
                  ),
                  child: isMobile
                      ? Column(
                          ...
                          children: [
                            ...
                            const Gap(16),
                            Text(
                              'CA services, filing helpers and calculators — mobile-first experience.',
                ...
                const Gap(8),
                Text(
                  'Deliver a reliable tax filing experience with offline support and secure document uploads.',
                  style: GoogleFonts.inter(color: Colors.white70),
                ),
                const Gap(24),
                Text(
                ...
                const Gap(8),
                Text(
                  'Implemented robust form flows, background uploads, and end-to-end testing; optimized UX for low-bandwidth scenarios.',
                  style: GoogleFonts.inter(color: Colors.white70),
                ),
                const Gap(32),
                ElevatedButton.icon(
